...
import me.ixor.sred.transfer.TransferContext
...
fun runTransfer(args: Array<String>) {
    runBlocking {
        ...
        // 显示初始状态
        TransferView.showInitialBalance(context.accountRepository.allAccounts())
        ...
        // 显示最终结果
        TransferView.showFinalBalance(context.accountRepository.allAccounts())
        result?.let { r ->
            runBlocking {
