...
object BranchingExample {
    ...
    fun main(args: Array<String>) = runBlocking {
        ...
        println("订单金额: 15000")
        val result1 = instance1.processEvent(EventFactory.createSimpleEvent("process", mapOf()))
        ...
        val result2 = instance2.processEvent(EventFactory.createSimpleEvent("start_audit", mapOf()))
        ...
        val result3 = instance3.processEvent(EventFactory.createSimpleEvent("process", mapOf()))
